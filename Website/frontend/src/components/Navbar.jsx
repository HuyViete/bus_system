...
const Navbar = ({ isSettingOpen, onSettingToggle, isRouteFilterOpen, onRouteFilterToggle, isRecentOpen, onRecentToggle, isSavedOpen, onSavedToggle }) => {
    return (
        <div className='fixed left-0 top-0 h-screen z-40 w-12 bg-white shadow-md flex flex-col'>
            ...
            <div className='flex flex-col mt-1'>
                ...
                <NavIconBtn icon={<IconBookmark />} label='Saved' active={isSavedOpen} onClick={onSavedToggle} />
                <NavIconBtn icon={<IconClock />} label='Recents' active={isRecentOpen} onClick={onRecentToggle} />
            </div>
        </div>
    )
}
